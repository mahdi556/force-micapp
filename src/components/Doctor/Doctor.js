    ...
    <>
      <div className={`d-flex flex-column mx-auto mt-3  ${styles.wrapper}`}>
        <div className={`mx-auto position-relative mt-2 ${styles.banner}`}>
          ...
          >
            <h3 className={styles.drTitle}>دکتر احمد فروتن</h3>
            <h3 className={styles.drExpert}>متخصص پوست،مو و زیبایی</h3>
          </div>
        </div>
        <div
        ...
        >
          ...
          <div className="d-flex align-items-center justify-content-between">
            <div className="d-flex flex-column align-items-center">
              <span className={styles.txt2}>124</span>
              <span className={styles.txt3}>شناسه میک اپ</span>
            </div>
            <div className="d-flex flex-column align-items-center">
              <span className={styles.txt2}>12542</span>
        ...
        <div className="row row-cols-2 px-3 mt-3 ">
